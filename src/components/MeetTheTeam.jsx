...
import man2Image from "../assets/img/png/man2Image.png";
...
const MeetTheTeam = () => {
  ...
  return (
    <div className="bg-black position-relative ">
         <img
          className="d-none d-lg-block animation_move_x position-absolute end-0 bottom_40"
          src={umebrelaAbsolute1}
          width={200}
          alt="umebrelaAbsolute1"
        />
      <img
        className="d-none d-lg-block animation_move position-absolute start-0 top_12"
        src={umebrelaAbsolute1}
        width={200}
        alt="umebrelaAbsolute1"
      />
      <div className="blur_background d-none d-lg-block  position-absolute end-0 top-50"></div>
      <Container>
        <h2 className="text-white text-center pt-3 pt-lg-5 ff_lato fw-bolder mb-0 fs_3xl">
          Meet the <span className="text_ecru"> Team</span>
        </h2>
        <Slider {...settings} className="py-3  py-lg-5">
          <Col className="my-2 my-lg-0 px-2" lg={6}>
            <div className="bg-white b_radius_25 h-100">
              <Row className="align-items-center">
                <Col className="mb-2 mb-sm-0" sm={6}>
                  <img
                    className="w-100 h_xsm_50 "
                    src={manImage}
                    alt="manImage"
                  />
                </Col>
                <Col className="my-2 my-sm-0" sm={6}>
                  <h2 className="text-center mb-0 ff_lato fw-bold fs_lg">
                    Varun Muthu
                  </h2>
                  <p className="text-center mt-3 ff_lato fw-medium fs_sm">
                    Marketing Director
                  </p>
                  <div className="text-center">
                    <a
                      className="text-center ff_lato fw-normal fs_xsm  text-black "
                      href="https://www.linkedin.com/in/varunmuthu1"
                    >
                      {" "}
                      https://www.linkedin.com/
                      <span> in/ varunmuthu1</span>
                    </a>
                  </div>
              ...
              <Row className=" align-items-center">
                ...
                <Col className="my-2 my-sm-0" sm={6}>
                  ...
                  <div className="text-center">
                    ...
                    >
                      https://www.linkedin.com/ <span> in/shubhsharma01/</span>
                    </a>
                  </div>
                  <div className="d-flex justify-content-center align-items-center pt-5">
                    <a className="p-2" href="#">
